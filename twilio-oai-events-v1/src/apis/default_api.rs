...
/// Create a new Sink
pub async fn create_sink(configuration: &configuration::Configuration, params: CreateSinkParams) -> Result<ResponseContent<CreateSinkSuccess>, Error<CreateSinkError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateSinkSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<CreateSinkError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn create_sink_test(configuration: &configuration::Configuration, params: CreateSinkTestParams) -> Result<ResponseContent<CreateSinkTestSuccess>, Error<CreateSinkTestError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Sinks/{Sid}/Test", local_var_configuration.base_path, Sid=crate::apis::urlencode(sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateSinkTestSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<CreateSinkTestError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn create_sink_validate(configuration: &configuration::Configuration, params: CreateSinkValidateParams) -> Result<ResponseContent<CreateSinkValidateSuccess>, Error<CreateSinkValidateError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Sinks/{Sid}/Validate", local_var_configuration.base_path, Sid=crate::apis::urlencode(sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateSinkValidateSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<CreateSinkValidateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn create_subscribed_event(configuration: &configuration::Configuration, params: CreateSubscribedEventParams) -> Result<ResponseContent<CreateSubscribedEventSuccess>, Error<CreateSubscribedEventError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Subscriptions/{SubscriptionSid}/SubscribedEvents", local_var_configuration.base_path, SubscriptionSid=crate::apis::urlencode(subscription_sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateSubscribedEventSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<CreateSubscribedEventError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn create_subscription(configuration: &configuration::Configuration, params: CreateSubscriptionParams) -> Result<ResponseContent<CreateSubscriptionSuccess>, Error<CreateSubscriptionError>> {
    let local_var_configuration = configuration;
    ...
    local_var_form_params.insert("Types", types.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string());
    local_var_req_builder = local_var_req_builder.form(&local_var_form_params);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateSubscriptionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn delete_sink(configuration: &configuration::Configuration, params: DeleteSinkParams) -> Result<ResponseContent<DeleteSinkSuccess>, Error<DeleteSinkError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Sinks/{Sid}", local_var_configuration.base_path, Sid=crate::apis::urlencode(sid));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteSinkSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<DeleteSinkError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn delete_subscribed_event(configuration: &configuration::Configuration, params: DeleteSubscribedEventParams) -> Result<ResponseContent<DeleteSubscribedEventSuccess>, Error<DeleteSubscribedEventError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Subscriptions/{SubscriptionSid}/SubscribedEvents/{Type}", local_var_configuration.base_path, SubscriptionSid=crate::apis::urlencode(subscription_sid), Type=crate::apis::urlencode(_type));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteSubscribedEventSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<DeleteSubscribedEventError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn delete_subscription(configuration: &configuration::Configuration, params: DeleteSubscriptionParams) -> Result<ResponseContent<DeleteSubscriptionSuccess>, Error<DeleteSubscriptionError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Subscriptions/{Sid}", local_var_configuration.base_path, Sid=crate::apis::urlencode(sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteSubscriptionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn fetch_event_type(configuration: &configuration::Configuration, params: FetchEventTypeParams) -> Result<ResponseContent<FetchEventTypeSuccess>, Error<FetchEventTypeError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Types/{Type}", local_var_configuration.base_path, Type=crate::apis::urlencode(_type));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchEventTypeSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchEventTypeError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_schema(configuration: &configuration::Configuration, params: FetchSchemaParams) -> Result<ResponseContent<FetchSchemaSuccess>, Error<FetchSchemaError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Schemas/{Id}", local_var_configuration.base_path, Id=crate::apis::urlencode(id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchSchemaSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchSchemaError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_schema_version(configuration: &configuration::Configuration, params: FetchSchemaVersionParams) -> Result<ResponseContent<FetchSchemaVersionSuccess>, Error<FetchSchemaVersionError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Schemas/{Id}/Versions/{SchemaVersion}", local_var_configuration.base_path, Id=crate::apis::urlencode(id), SchemaVersion=schema_version);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchSchemaVersionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchSchemaVersionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_sink(configuration: &configuration::Configuration, params: FetchSinkParams) -> Result<ResponseContent<FetchSinkSuccess>, Error<FetchSinkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchSinkSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchSinkError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_subscribed_event(configuration: &configuration::Configuration, params: FetchSubscribedEventParams) -> Result<ResponseContent<FetchSubscribedEventSuccess>, Error<FetchSubscribedEventError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchSubscribedEventSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchSubscribedEventError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_subscription(configuration: &configuration::Configuration, params: FetchSubscriptionParams) -> Result<ResponseContent<FetchSubscriptionSuccess>, Error<FetchSubscriptionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchSubscriptionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchSubscriptionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_event_type(configuration: &configuration::Configuration, params: ListEventTypeParams) -> Result<ResponseContent<ListEventTypeSuccess>, Error<ListEventTypeError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = schema_id {
        local_var_req_builder = local_var_req_builder.query(&[("SchemaId", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListEventTypeSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListEventTypeError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_schema_version(configuration: &configuration::Configuration, params: ListSchemaVersionParams) -> Result<ResponseContent<ListSchemaVersionSuccess>, Error<ListSchemaVersionError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Schemas/{Id}/Versions", local_var_configuration.base_path, Id=crate::apis::urlencode(id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListSchemaVersionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListSchemaVersionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_sink(configuration: &configuration::Configuration, params: ListSinkParams) -> Result<ResponseContent<ListSinkSuccess>, Error<ListSinkError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = in_use {
        local_var_req_builder = local_var_req_builder.query(&[("InUse", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListSinkSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn list_subscribed_event(configuration: &configuration::Configuration, params: ListSubscribedEventParams) -> Result<ResponseContent<ListSubscribedEventSuccess>, Error<ListSubscribedEventError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListSubscribedEventSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListSubscribedEventError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_subscription(configuration: &configuration::Configuration, params: ListSubscriptionParams) -> Result<ResponseContent<ListSubscriptionSuccess>, Error<ListSubscriptionError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = sink_sid {
        local_var_req_builder = local_var_req_builder.query(&[("SinkSid", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = page_size {
        local_var_req_builder = local_var_req_builder.query(&[("PageSize", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListSubscriptionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListSubscriptionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_sink(configuration: &configuration::Configuration, params: UpdateSinkParams) -> Result<ResponseContent<UpdateSinkSuccess>, Error<UpdateSinkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateSinkSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<UpdateSinkError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_subscribed_event(configuration: &configuration::Configuration, params: UpdateSubscribedEventParams) -> Result<ResponseContent<UpdateSubscribedEventSuccess>, Error<UpdateSubscribedEventError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateSubscribedEventSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<UpdateSubscribedEventError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_subscription(configuration: &configuration::Configuration, params: UpdateSubscriptionParams) -> Result<ResponseContent<UpdateSubscriptionSuccess>, Error<UpdateSubscriptionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateSubscriptionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
