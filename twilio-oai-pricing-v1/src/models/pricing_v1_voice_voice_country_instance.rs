...
pub struct PricingV1VoiceVoiceCountryInstance {
    ...
    #[serde(rename = "inbound_call_prices", skip_serializing_if = "Option::is_none")]
    pub inbound_call_prices: Option<Vec<crate::models::PricingV1MessagingMessagingCountryInstanceInboundSmsPrices>>,
    /// The ISO country code
    #[serde(rename = "iso_country", skip_serializing_if = "Option::is_none")]
    pub iso_country: Option<String>,
    /// The list of OutboundPrefixPrice records
    #[serde(rename = "outbound_prefix_prices", skip_serializing_if = "Option::is_none")]
    pub outbound_prefix_prices: Option<Vec<crate::models::PricingV1VoiceVoiceCountryInstanceOutboundPrefixPrices>>,
