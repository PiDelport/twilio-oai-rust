...
pub struct PricingV2TrunkingCountryInstance {
    ...
    #[serde(rename = "originating_call_prices", skip_serializing_if = "Option::is_none")]
    pub originating_call_prices: Option<Vec<crate::models::PricingV2TrunkingCountryInstanceOriginatingCallPrices>>,
