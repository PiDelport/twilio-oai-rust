...
pub struct TaskrouterV1WorkspaceTask {
    ...
    #[serde(rename = "task_queue_entered_date", skip_serializing_if = "Option::is_none")]
    pub task_queue_entered_date: Option<String>,
    /// The friendly name of the TaskQueue
    #[serde(rename = "task_queue_friendly_name", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "workflow_friendly_name", skip_serializing_if = "Option::is_none")]
