...
pub struct TaskrouterV1WorkspaceWorkflow {
    ...
    #[serde(rename = "assignment_callback_url", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "document_content_type", skip_serializing_if = "Option::is_none")]
    pub document_content_type: Option<String>,
    /// The URL that we call when a call to the `assignment_callback_url` fails
    #[serde(rename = "fallback_assignment_callback_url", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "task_reservation_timeout", skip_serializing_if = "Option::is_none")]
