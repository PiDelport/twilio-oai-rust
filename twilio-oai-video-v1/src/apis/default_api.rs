...
pub async fn create_composition(configuration: &configuration::Configuration, params: CreateCompositionParams) -> Result<ResponseContent<CreateCompositionSuccess>, Error<CreateCompositionError>> {
    ...
    if let Some(local_var_param_value) = audio_sources {
        local_var_form_params.insert("AudioSources", local_var_param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string());
    }
    if let Some(local_var_param_value) = audio_sources_excluded {
        local_var_form_params.insert("AudioSourcesExcluded", local_var_param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateCompositionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<CreateCompositionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn create_composition_hook(configuration: &configuration::Configuration, params: CreateCompositionHookParams) -> Result<ResponseContent<CreateCompositionHookSuccess>, Error<CreateCompositionHookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateCompositionHookSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<CreateCompositionHookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn create_composition_settings(configuration: &configuration::Configuration, params: CreateCompositionSettingsParams) -> Result<ResponseContent<CreateCompositionSettingsSuccess>, Error<CreateCompositionSettingsError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/CompositionSettings/Default", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateCompositionSettingsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<CreateCompositionSettingsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn create_recording_settings(configuration: &configuration::Configuration, params: CreateRecordingSettingsParams) -> Result<ResponseContent<CreateRecordingSettingsSuccess>, Error<CreateRecordingSettingsError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/RecordingSettings/Default", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateRecordingSettingsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<CreateRecordingSettingsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn create_room(configuration: &configuration::Configuration, params: CreateRoomParams) -> Result<ResponseContent<CreateRoomSuccess>, Error<CreateRoomError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(local_var_param_value) = record_participants_on_connect {
        local_var_form_params.insert("RecordParticipantsOnConnect", local_var_param_value.to_string());
    }
    ...
    if let Some(local_var_param_value) = video_codecs {
        local_var_form_params.insert("VideoCodecs", local_var_param_value.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string());
    }
    local_var_req_builder = local_var_req_builder.form(&local_var_form_params);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateRoomSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn delete_composition(configuration: &configuration::Configuration, params: DeleteCompositionParams) -> Result<ResponseContent<DeleteCompositionSuccess>, Error<DeleteCompositionError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Compositions/{Sid}", local_var_configuration.base_path, Sid=crate::apis::urlencode(sid));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteCompositionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<DeleteCompositionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn delete_composition_hook(configuration: &configuration::Configuration, params: DeleteCompositionHookParams) -> Result<ResponseContent<DeleteCompositionHookSuccess>, Error<DeleteCompositionHookError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/CompositionHooks/{Sid}", local_var_configuration.base_path, Sid=crate::apis::urlencode(sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteCompositionHookSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<DeleteCompositionHookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn delete_recording(configuration: &configuration::Configuration, params: DeleteRecordingParams) -> Result<ResponseContent<DeleteRecordingSuccess>, Error<DeleteRecordingError>> {
    ...
    let local_var_uri_str = format!("{}/v1/Recordings/{Sid}", local_var_configuration.base_path, Sid=crate::apis::urlencode(sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_room_recording(configuration: &configuration::Configuration, params: DeleteRoomRecordingParams) -> Result<ResponseContent<DeleteRoomRecordingSuccess>, Error<DeleteRoomRecordingError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{RoomSid}/Recordings/{Sid}", local_var_configuration.base_path, RoomSid=crate::apis::urlencode(room_sid), Sid=crate::apis::urlencode(sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteRoomRecordingSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<DeleteRoomRecordingError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_composition(configuration: &configuration::Configuration, params: FetchCompositionParams) -> Result<ResponseContent<FetchCompositionSuccess>, Error<FetchCompositionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchCompositionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchCompositionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_composition_hook(configuration: &configuration::Configuration, params: FetchCompositionHookParams) -> Result<ResponseContent<FetchCompositionHookSuccess>, Error<FetchCompositionHookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchCompositionHookSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchCompositionHookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn fetch_composition_settings(configuration: &configuration::Configuration) -> Result<ResponseContent<FetchCompositionSettingsSuccess>, Error<FetchCompositionSettingsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchCompositionSettingsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchCompositionSettingsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_recording_settings(configuration: &configuration::Configuration) -> Result<ResponseContent<FetchRecordingSettingsSuccess>, Error<FetchRecordingSettingsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchRecordingSettingsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchRecordingSettingsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn fetch_room(configuration: &configuration::Configuration, params: FetchRoomParams) -> Result<ResponseContent<FetchRoomSuccess>, Error<FetchRoomError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{Sid}", local_var_configuration.base_path, Sid=crate::apis::urlencode(sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchRoomSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchRoomError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn fetch_room_participant(configuration: &configuration::Configuration, params: FetchRoomParticipantParams) -> Result<ResponseContent<FetchRoomParticipantSuccess>, Error<FetchRoomParticipantError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{RoomSid}/Participants/{Sid}", local_var_configuration.base_path, RoomSid=crate::apis::urlencode(room_sid), Sid=crate::apis::urlencode(sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchRoomParticipantSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchRoomParticipantError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_room_participant_published_track(configuration: &configuration::Configuration, params: FetchRoomParticipantPublishedTrackParams) -> Result<ResponseContent<FetchRoomParticipantPublishedTrackSuccess>, Error<FetchRoomParticipantPublishedTrackError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{RoomSid}/Participants/{ParticipantSid}/PublishedTracks/{Sid}", local_var_configuration.base_path, RoomSid=crate::apis::urlencode(room_sid), ParticipantSid=crate::apis::urlencode(participant_sid), Sid=crate::apis::urlencode(sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchRoomParticipantPublishedTrackSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchRoomParticipantPublishedTrackError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_room_participant_subscribe_rule(configuration: &configuration::Configuration, params: FetchRoomParticipantSubscribeRuleParams) -> Result<ResponseContent<FetchRoomParticipantSubscribeRuleSuccess>, Error<FetchRoomParticipantSubscribeRuleError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{RoomSid}/Participants/{ParticipantSid}/SubscribeRules", local_var_configuration.base_path, RoomSid=crate::apis::urlencode(room_sid), ParticipantSid=crate::apis::urlencode(participant_sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchRoomParticipantSubscribeRuleSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchRoomParticipantSubscribeRuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_room_participant_subscribed_track(configuration: &configuration::Configuration, params: FetchRoomParticipantSubscribedTrackParams) -> Result<ResponseContent<FetchRoomParticipantSubscribedTrackSuccess>, Error<FetchRoomParticipantSubscribedTrackError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{RoomSid}/Participants/{ParticipantSid}/SubscribedTracks/{Sid}", local_var_configuration.base_path, RoomSid=crate::apis::urlencode(room_sid), ParticipantSid=crate::apis::urlencode(participant_sid), Sid=crate::apis::urlencode(sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchRoomParticipantSubscribedTrackSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchRoomParticipantSubscribedTrackError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn fetch_room_recording(configuration: &configuration::Configuration, params: FetchRoomRecordingParams) -> Result<ResponseContent<FetchRoomRecordingSuccess>, Error<FetchRoomRecordingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchRoomRecordingSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchRoomRecordingError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn fetch_room_recording_rule(configuration: &configuration::Configuration, params: FetchRoomRecordingRuleParams) -> Result<ResponseContent<FetchRoomRecordingRuleSuccess>, Error<FetchRoomRecordingRuleError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{RoomSid}/RecordingRules", local_var_configuration.base_path, RoomSid=crate::apis::urlencode(room_sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<FetchRoomRecordingRuleSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<FetchRoomRecordingRuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_composition(configuration: &configuration::Configuration, params: ListCompositionParams) -> Result<ResponseContent<ListCompositionSuccess>, Error<ListCompositionError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = room_sid {
        local_var_req_builder = local_var_req_builder.query(&[("RoomSid", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListCompositionSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListCompositionError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_composition_hook(configuration: &configuration::Configuration, params: ListCompositionHookParams) -> Result<ResponseContent<ListCompositionHookSuccess>, Error<ListCompositionHookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListCompositionHookSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListCompositionHookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_recording(configuration: &configuration::Configuration, params: ListRecordingParams) -> Result<ResponseContent<ListRecordingSuccess>, Error<ListRecordingError>> {
    ...
    if let Some(ref local_var_str) = source_sid {
        local_var_req_builder = local_var_req_builder.query(&[("SourceSid", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = grouping_sid {
        local_var_req_builder = local_var_req_builder.query(&[("GroupingSid", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]);
    }
    if let Some(ref local_var_str) = date_created_after {
        local_var_req_builder = local_var_req_builder.query(&[("DateCreatedAfter", &local_var_str.to_string())]);
    }
...
pub async fn list_room(configuration: &configuration::Configuration, params: ListRoomParams) -> Result<ResponseContent<ListRoomSuccess>, Error<ListRoomError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = unique_name {
        local_var_req_builder = local_var_req_builder.query(&[("UniqueName", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = date_created_after {
        local_var_req_builder = local_var_req_builder.query(&[("DateCreatedAfter", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListRoomSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn list_room_participant(configuration: &configuration::Configuration, params: ListRoomParticipantParams) -> Result<ResponseContent<ListRoomParticipantSuccess>, Error<ListRoomParticipantError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{RoomSid}/Participants", local_var_configuration.base_path, RoomSid=crate::apis::urlencode(room_sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListRoomParticipantSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListRoomParticipantError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_room_participant_published_track(configuration: &configuration::Configuration, params: ListRoomParticipantPublishedTrackParams) -> Result<ResponseContent<ListRoomParticipantPublishedTrackSuccess>, Error<ListRoomParticipantPublishedTrackError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{RoomSid}/Participants/{ParticipantSid}/PublishedTracks", local_var_configuration.base_path, RoomSid=crate::apis::urlencode(room_sid), ParticipantSid=crate::apis::urlencode(participant_sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListRoomParticipantPublishedTrackSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListRoomParticipantPublishedTrackError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_room_participant_subscribed_track(configuration: &configuration::Configuration, params: ListRoomParticipantSubscribedTrackParams) -> Result<ResponseContent<ListRoomParticipantSubscribedTrackSuccess>, Error<ListRoomParticipantSubscribedTrackError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{RoomSid}/Participants/{ParticipantSid}/SubscribedTracks", local_var_configuration.base_path, RoomSid=crate::apis::urlencode(room_sid), ParticipantSid=crate::apis::urlencode(participant_sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListRoomParticipantSubscribedTrackSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListRoomParticipantSubscribedTrackError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_room_recording(configuration: &configuration::Configuration, params: ListRoomRecordingParams) -> Result<ResponseContent<ListRoomRecordingSuccess>, Error<ListRoomRecordingError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!("{}/v1/Rooms/{RoomSid}/Recordings", local_var_configuration.base_path, RoomSid=crate::apis::urlencode(room_sid));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListRoomRecordingSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListRoomRecordingError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_composition_hook(configuration: &configuration::Configuration, params: UpdateCompositionHookParams) -> Result<ResponseContent<UpdateCompositionHookSuccess>, Error<UpdateCompositionHookError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateCompositionHookSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<UpdateCompositionHookError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_room(configuration: &configuration::Configuration, params: UpdateRoomParams) -> Result<ResponseContent<UpdateRoomSuccess>, Error<UpdateRoomError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateRoomSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
...
pub async fn update_room_participant(configuration: &configuration::Configuration, params: UpdateRoomParticipantParams) -> Result<ResponseContent<UpdateRoomParticipantSuccess>, Error<UpdateRoomParticipantError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateRoomParticipantSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<UpdateRoomParticipantError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_room_participant_subscribe_rule(configuration: &configuration::Configuration, params: UpdateRoomParticipantSubscribeRuleParams) -> Result<ResponseContent<UpdateRoomParticipantSubscribeRuleSuccess>, Error<UpdateRoomParticipantSubscribeRuleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateRoomParticipantSubscribeRuleSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<UpdateRoomParticipantSubscribeRuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn update_room_recording_rule(configuration: &configuration::Configuration, params: UpdateRoomRecordingRuleParams) -> Result<ResponseContent<UpdateRoomRecordingRuleSuccess>, Error<UpdateRoomRecordingRuleError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateRoomRecordingRuleSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<UpdateRoomRecordingRuleError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
